...
import img1 from '../../public/Rectangle 27.png';
import img2 from '../../public/Rectangle 27-1.png';
import img3 from '../../public/Rectangle 27-2.png';
const Health = () => {
     return (
         ...
         <div>
           <div>
             ...
             <p className="w-[470px] mb-16">
               ...
               every patient we serve. Whatever your healthcare needs may be,
               you can trust us to be your partner in health and wellness.
             </p>
             <div>
               ...
               <div className="flex justify-end gap-4">
                 <div>
                   ...
                   <p className="text-[#FFFFFFCC] text-xs  ">
                     Our surgeons are trained in the latest <br /> robotic
                     surgical techniques, which <br /> allow for greater
                     precision
                   </p>
                 </div>
